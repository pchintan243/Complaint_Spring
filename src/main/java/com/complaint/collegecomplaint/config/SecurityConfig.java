    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(c -> c.disable())
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/api/getAllUsers")
                        .hasAnyAuthority("Administrator", "AssistantManager", "FacultyHead")
                        .requestMatchers("/auth/adminRegister").hasAuthority("Administrator")
                        .requestMatchers("/auth/astRegister").hasAnyAuthority("Administrator")
                        .requestMatchers("/auth/headRegister").hasAnyAuthority("Administrator")
                        .requestMatchers("/complaint/**").hasAnyAuthority("User", "Administrator", "FacultyHead", "AssistantManager")
